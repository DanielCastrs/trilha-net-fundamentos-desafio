namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            veiculos.Add(placa);
            Console.WriteLine($"Voce adicionou {placa.ToUpper()}");
...
{
	            Console.WriteLine($"Nº{contadorForeach} - {valor.ToUpper()}");
	            contadorForeach++;
}
                Console.WriteLine($"Temos {veiculos.Count()} carros no estacionamento comando");
